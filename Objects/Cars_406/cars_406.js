...
/*const carsWithMPG = cars.filter(car => car.Miles_per_Gallon !== undefined);
console.log(carsWithMPG);*/
// lektoriaus kodas:

const carArray = cars.filter((car)=>{
...
/*const carsWithNoNPG = cars.filter(car => car.Miles_per_Gallon == undefined)
console.log(carsWithNoNPG)*/
// lektoriaus kodas:

const carsArray1 = cars.filter((car)=>{
  return !car.Miles_per_Gallon
})
...
const carsWithParams = cars.filter(car => car.Cylinders === 8 && cars.Miles_per_Gallon >= 15);
console.log(carsWithParams);
...
/*const carsWithKW = cars.map(car => ({
    ...car,
    Kilowatts: car.Horsepower * 0.7457
  }));
  
  console.log(carsWithKW);*/
  // lektoriaus kodas:
  const userCars = cars.map((car)=>{
    return {Kilowatts: (car.Horsepower * 0.74570).toFixed(2), ...car}
})
...
const carsSortedByWeight = cars.sort((a, b) => a.Weight_in_lbs - b.Weight_in_lbs);
console.log(carsSortedByWeight);

// 1.6 Parašyti komandą kuri gražins true arba false reikšmę tikrinant ar visi automobiliai yra pagaminti "USA".

const carsMadeUSA = cars.every(car => car.Country === 'USA');
console.log(carsMadeUSA);
